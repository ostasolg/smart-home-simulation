...
/**
 * This class represents third configuration of house.
 *
 * @author Oľga Ostashchuk, Tereza Lodrová, Michal Pechník
 * @version 1.0
 */
public class RunningConfig3 implements RunningConfig {
    ...
    public House createRunningConfigOfHouse() {
        ...
        TV tv2 = deviceFactory.createTV(100,1,0,0);

        Radio radio = deviceFactory.createRadio(30,1,0,0);
        Radio radio1 = deviceFactory.createRadio(30,1,0,0);
        Radio radio2 = deviceFactory.createRadio(30,1,0,0);
        ...
        House house = new HouseBuilder().buildFloor(new Floor(0)).buildFloor(new Floor(1))
                ...
                .addDevice(radio1,"Bathroom")
                .addDevice(radio2,"Kids bedroom")
                .addDevice(tv,"Living room")
                .addDevice(tv1,"Bathroom")
                .addDevice(tv2,"Kids bedroom")
                .addDevice(fridge,"Kitchen")
                .addDevice(washingMachine,"Bathroom")
                .addDevice(washingMachine1,"Attic")
                ...
                .addEquipment(bike1)
                .addEquipment(ski1)
                .addPerson(new Person("Josif",52),"Bedroom")
                .addPerson(new Person("John",27),"Study")
                .addPerson(new Person("Ivan",13),"Kids bedroom")
                .addPerson(new Person("Thomas",94),"Living room")
                .addPerson(new Person("Joseph",50), "Kitchen")
                .addPerson(new Person("Rosalinde",56), "Attic")
                .addPet(new Pet("Jerry","Dog"))
                .addPet(new Pet("Lolita","Hamster"))
